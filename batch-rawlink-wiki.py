...
SUFFIX_FEATS = ".features.xml.gz"
SUFFIX_STATS = ".stats.xml.gz"
...
def create_pool(batch_service_client, pool_id):
    ...
    task_commands = [
        ...
        "cd ..",
        "git clone https://github.com/WikiLinkGraphs/wikidump.git",
        "cd wikidump ",
        "python3 setup.py install",
        "cd ..",
...
def add_tasks(batch_service_client, job_id, input_files, output_container_sas_url_f,output_container_sas_url_s):
    """
    ...
    for idx, input_file in enumerate(input_files):
        ...
        input_f = input_file_path.split("/")[-1]
        output_file_path_f = input_f+SUFFIX_FEATS
        output_file_path_s = input_f+SUFFIX_STATS
        command = f"/bin/bash -c \"wikidump --output-compression gzip {input_file_path} . extract-wikilinks && rm {input_file_path}\""
                ...
                batchmodels.OutputFile(
                    ...
                    destination=batchmodels.OutputFileDestination(
                            container=batchmodels.OutputFileBlobContainerDestination(
                                ...
                                path="rawwikilinks/2020-05-01/enwiki/"+output_file_path_f)),
                ...
                batchmodels.OutputFile(
                    ...
                    destination=batchmodels.OutputFileDestination(
                            container=batchmodels.OutputFileBlobContainerDestination(
                                ...
                                path="rawwikilinks/2020-05-01/enwiki/"+output_file_path_s)),
                    upload_options=batchmodels.OutputFileUploadOptions(
                        upload_condition=batchmodels.OutputFileUploadCondition.task_success))]
            )
        )
...
if __name__ == '__main__':
    ...
    # Create a list of all dunp files.
    input_file_paths = ["dumps/en/20200501/metahistory7zdump/"+file for file in FILELIST]

    #c. This is the collection of files that are to be processed by the tasks.
    input_files = [
    ...
    try:
        ...
        add_tasks(batch_client, JOB_ID,
                  input_files, output_container_sas_url_f,output_container_sas_url_s)
